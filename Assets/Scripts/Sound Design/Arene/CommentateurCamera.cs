...
public class CommentateurCamera : MonoBehaviour
{
    ...
    /*
    public IEnumerator CanCommentstart(float dur�e)
    {
    ...
    public IEnumerator CommentDiane(float dur�e)
    {
    ...
    public IEnumerator CommentCesar(float dur�e)
    {
    ...
    /*public IEnumerator PresentationJoueur(float dur�e)
    {
